                                        ...
                                        <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                       <div class="container">
                                                        ...
                                                        <br>
                                                        <br>
                                                        <label style="font-size:20px" for="">Phone thumbnail</label><br>
                                                       <a href="{{$product_info->product_thumbnail}}" target="_blank"><img src="{{$product_info->product_thumbnail}}" alt=""></a> 
                                                        <br>
                                                        <br>
